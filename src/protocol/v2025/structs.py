...
Final Classification, Lobby Info, Car Damage, Session History, Tyre Sets, Motion Ex, Time Trial, Lap Positions).
"""
...
_NUM_CARS = 22  # max number of cars in a session, per the UDP appendices (2025)
...
class CarMotionData(_Struct):
    ...
    _fields_ = [
        ...
        ("g_force_lateral", ct.c_float),        # Lateral G-Force component
        ("g_force_longitudinal", ct.c_float),   # Longitudinal G-Force component
        ("g_force_vertical", ct.c_float),       # Vertical G-Force component
...
class ParticipantData(_Struct):
    ...
    _fields_ = [
        ...
        ("driver_id", ct.c_uint8),       # Driver id - see enums.DriverId
        ("network_id", ct.c_uint8),      # Network id - unique identifier for network players
        ("team_id", ct.c_uint8),         # Team id - see enums.TeamId
...
class CarTelemetryData(_Struct):
    ...
    _fields_ = [
        ...
        ("engine_temperature", ct.c_uint16),            # Engine temperature (celsius)
